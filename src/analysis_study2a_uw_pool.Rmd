...
## Read data
```{r}
codebook_vars <- readxl::read_excel("lib/Codebook_Study 2A Psych Pool_Winter2021_EWB Shift Persist.xlsx", sheet="variables")
codebook_values <- readxl::read_excel("lib/Codebook_Study 2A Psych Pool_Winter2021_EWB Shift Persist.xlsx", sheet="values")

df_file <- readxl::read_excel("data/raw/Study 2A UW Psych Pool_EWB GB.xlsx") %>% 
  slice(-1)
